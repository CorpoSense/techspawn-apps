...
class InvoiceOrderSend(models.Model):
    ...
    def action_whatsapp(self):
        ...
        custom_msg = "Hello *{}*, your Invoice *{}* amount is of *{} {}*. \nYour invoice contains following items:\n {}".format(str(self.partner_id.name),str(self.number),str(self.amount_total),str(self.currency_id.symbol),prods)
